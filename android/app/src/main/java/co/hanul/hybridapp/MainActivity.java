...
import co.hanul.hybridapp.gpgs.GameServiceController;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static JSCallback loginGameServiceErrorHandler;
    private static JSCallback loginGameServiceCallback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameServiceController = new GameServiceController(this);
    ...
    private class WebAppInterface {
        ...
        public void loginGameService(String errorHandlerName, String callbackName) {
            ...
            gameServiceController.login();
        }

        @JavascriptInterface
        public void showAchievements() {
            gameServiceController.showAchievements();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == GameServiceController.RC_SIGN_IN) {
